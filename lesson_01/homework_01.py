...
apples = 2
bananas = apples * 4  # this is a simple solution if we have "2" apples only.

"""
But we have a tech task that we should always have *4 bananas than apples.
We can build a function that will count bananas from our apples number.
"""

apples = 2


def bananas_count(apples):
    """Return the number of bananas as four times the number of apples."""
    return apples * 4


bananas = bananas_count(apples)
