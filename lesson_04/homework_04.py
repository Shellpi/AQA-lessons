...
adwentures_of_tom_sawer = (adwentures_of_tom_sawer.replace(('    '), (' ')).replace(('   '), (' ')).replace(('  '), (' ')))
...
sentence_checker = any(sentence.strip().startswith('By the time') for sentence in adwentures_of_tom_sawer_sentences)
if sentence_checker:
